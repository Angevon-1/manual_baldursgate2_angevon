...
To reduce the amount of cheat console and save editing, I made a mod for the game. The mod adds an item to Imoen's inventory at the start of the game, and to the Adventurer's Mart in Waukeen's Promenade. When you right-click -> Converse with the item, it opens a convenient dialogue tree you can use to teleport and receive items. 

When you first talk to the mod, you should tell it your yaml settings so it can show/hide the correct items for you to pick. (e.g. tell it you've skipped Irenicus Dungeon so that it won't show you Frennedan's key or the Portal key)<br/>
...
<b>IMPORTANT: Do not teleport to an area or chapter you haven't reached yet in the story!</b> (e.g. don't go to Brynnlaw when you're still in chapter 2). It may cause quest bugs! The manual will expect you to complete chapters before moving on. You might receive an area unlock for a later chapter before you complete your current chapter, that's just how randomizers are, but you won't be expected to go there until you've completed the previous chapters.

## Cheat console information:
If you use the GO_AP mod, you shouldn't need the cheat console except to give yourself any gold received from the multiworld (technical limitation of the mod, it cannot give gold).  However, if you'd rather use the cheat console for everything, steps are provided below. The steps have been collapsed to avoid confusion.

<details>
<summary>Click here to expand the cheat console guide.</summary>
...
Say you've received "Boots of Speed" from the multiworld. The item code for Boots of Speed is boot01. 
To receive it in game, you'd type the following into the cheat console. Again, the command will change based on version.
...
Instead of using the cheat console, a save editor like <a href="https://sorcerers.net/Games/BG2/index_editors.php">Shadowkeeper</a> (classic) or <a href="https://sourceforge.net/projects/eekeeper/">EEKeeper</a> (enhanced) can be used to edit received items directly into your inventory and your gold amount. Save editors don't have a teleport option so you'll still need the cheat console or GO_AP mod to teleport.
